...
ENTRYPOINT ["/bin/sh", "-c" , "echo \"192.168.50.135 broker\"",">>","/etc/hosts&&","exec","/bin/java","-jar","-Dspring.config.location=/configs/execution.properties","/testfiles/executor.jar"]
